...
export default function TaskFilters() {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 items-start md:items-center xl:items-end gap-4 w-full xl:flex xl:justify-end">
